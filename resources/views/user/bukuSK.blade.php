            ...
            <div class="card">
                <div class="card-body">
                    <div style="padding-bottom: 20px; padding-top: 10px">
                        <form action="{{ route('user.bukuSK') }}" method="GET" class="d-flex align-items-center">
                            ...
                            <button class="btn btn-outline-success" type="button" onclick="window.location.href='{{ route('user.bukuSK.export', ['dari_tanggal' => request()->query('dari_tanggal'), 'sampai_tanggal' => request()->query('sampai_tanggal')]) }}'">Export</button>
                        </form>
                    </div> 
                    <table class="table">
                        <thead>
