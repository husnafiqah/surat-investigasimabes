...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="red">
        <div class="sidebar-wrapper" id="sidebar-wrapper">
            ...
            <li class="">
                ...
                <li class="">
                    <a class="active" data-bs-toggle="collapse" href="#buku-collapse" aria-expanded="true">
    ...
    <div class="main-panel">
        <div class="container" style="padding-left: 30px; padding-right: 30px; ">
            <h2><b>Buku Agenda - Surat Keluar</b></h2>
            <div class="card">
                <div class="card-body">
                    <div style="padding-bottom: 20px; padding-top: 10px">
                        <form action="{{ route('kepala.bukuSK') }}" method="GET" class="d-flex align-items-center">
                            ...
                            <button class="btn btn-outline-success" type="button" onclick="window.location.href='{{ route('kepala.bukuSK.export', ['dari_tanggal' => request()->query('dari_tanggal'), 'sampai_tanggal' => request()->query('sampai_tanggal')]) }}'">Export</button>
                        </form>
                    </div> 
                    <table class="table">
                        <thead>
