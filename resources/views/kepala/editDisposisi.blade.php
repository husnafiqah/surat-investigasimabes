        ...
        <div class="container" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <form action="{{ route('kepala.disposisi.update', ['id' => $disposisi->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ route('kepala.disposisi', ['id' => $disposisi->surat_masuk_id]) }}" class="btn btn-secondary">Batal</a>
                        </form>
                        </div>
                    </div>
                </div>
