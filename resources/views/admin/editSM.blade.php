...
<div class="wrapper">
    ...
    <div class="main-panel">
        <div class="container" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.updateSM', $suratMasuk->id) }}" method="POST" enctype="multipart/form-data" style="padding-left: 10px; padding-right: 10px;">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="noAgenda" class="form-label">No Agenda</label>
                                    <input type="text" class="form-control" id="noAgenda" value="{{ $suratMasuk->id }}" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="noSurat" name="nomor_surat" value="{{ $suratMasuk->nomor_surat }}" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tanggalSurat" class="form-label">Tanggal Surat</label>
                                    <input type="date" class="form-control" id="tanggalSurat" name="tanggal_surat" value="{{ $suratMasuk->tanggal_surat }}" >
                                </div>
                                <div class="mb-3">
                                    <label for="tanggalDiterima" class="form-label">Tanggal Diterima</label>
                                    <input type="date" class="form-control" id="tanggalDiterima" name="tanggal_diterima" value="{{ $suratMasuk->tanggal_diterima }}" >
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ $suratMasuk->keterangan }}</textarea>
                            </div>
                            <div class="mb-3">
